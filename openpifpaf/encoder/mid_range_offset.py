...
class MidRangeOffset(object):
    ...
    def __call__(self, anns, width_height_original):
        ...
        f = MidRangeOffsetGenerator(self.min_size, self.skeleton,
                         v_threshold=self.v_threshold,
                         fixed_size=self.fixed_size,
                         aspect_ratio=self.aspect_ratio,
                         sigmas=self.sigmas,
                         anns=anns)
        f.init_fields(width_height_original)
        f.fill(keypoint_sets)
        return f.fields()


class MidRangeOffsetGenerator(object):
    ...
    def init_fields(self, width_height_original):
    ...
    def fill_keypoints(self, keypoints, other_keypoints):
        ...
        for i, (joint1i, joint2i) in enumerate(self.skeleton):
            ...
            scale1, scale2, max_r1, max_r2 = 0,0,0,0
